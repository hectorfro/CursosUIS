# 📋 GUÍA COMPLETA DE TRABAJO COLABORATIVO EN COLAB
...
7. **Renombra el archivo** según las instrucciones del profesor:
   - Formato: `GXX_Practica01_Pendulo.ipynb`
   - Ejemplo: `G04_Practica01_Pendulo.ipynb` (Grupo 04)
...
### **PASO 6: REVISIÓN DE HITOS (OPCIONAL PERO RECOMENDADO)**

**Responsable:** Estudiante C (Analista)

**Objetivo:** Guardar versiones importantes del trabajo para poder volver atrás si algo sale mal.

**Acciones:**

1. Ve al menú: **Archivo → Historial de revisiones**
2. Aparecerá una lista cronológica de todas las versiones guardadas
3. Busca un momento importante (ej: "Tabla y Figura completadas")
4. Haz clic en el **círculo gris** al lado de esa versión
5. Aparecerá un icono de **chincheta 📌**
6. Haz clic en la chincheta y escribe un nombre descriptivo:
   - Ejemplo: `✅ Secciones 1-4 completas`
   - Ejemplo: `✅ Código y figuras terminados`
   - Ejemplo: `✅ Versión final pre-entrega`

**Hitos sugeridos:**
- ✅ Portada y roles completados
- ✅ Marco teórico finalizado
- ✅ Datos ingresados y código funcional
- ✅ Tabla y figura generadas
- ✅ Discusión y conclusiones escritas
- ✅ Documento completo - listo para PDF

✅ **Verificación:** Al menos 3 versiones guardadas con nombres claros.

---

### **PASO 7: VERIFICACIÓN FINAL** (Todo el equipo)
...
### **PASO 8: GENERACIÓN DEL PDF** (Estudiante C)
...
5. Nombra el archivo según instrucciones del profesor:
   - Formato: `GXX_Practica01_Pendulo.pdf`
   - Ejemplo: `G04_Practica01_Pendulo.pdf`
...
### **PASO 9: ENTREGA EN LA PLATAFORMA** (Estudiante C principalmente)
...
- Estado: **Entregado**
- Archivo adjunto: **GXX_Practica01_Pendulo.pdf**
...
1. **Problemas de acceso:** Verifica que estás usando tu correo institucional UIS
